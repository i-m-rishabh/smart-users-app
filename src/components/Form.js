...
const Form = (props) => {
    ...
    function formSubmitHandler(event) {
        ...
        let college = collegeRef.current.value;
        ...
        if (name.trim().length === 0 || age.trim().length === 0 || college.trim().length === 0) {
            ...
            if (age < 0) {
                ...
                props.OnAddUser(name, parseInt(age), college);
                // setName('');
                // setAge('');
    ...
    return (
        <div className='container'>
            <form onSubmit={formSubmitHandler}>
                ...
                <label htmlFor="user_college">college</label>
                <input type="text" name="user_college" id="user_college" placeholder='enter college name' ref={collegeRef} />
